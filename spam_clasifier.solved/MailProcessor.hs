module MailProcessor (processEmail', processEmail) where

import Types (Vocabulary, emptyVocabulary, strToInt)
...
processEmail :: Vocabulary -> String -> [Int] 
processEmail voc = mapMaybe (`strToInt` voc) . processEmail'
